...
const Login = () => {
  ...
  return (
    ...
    <div class="min-h-screen flex items-center justify-center w-full white:bg-gray-950">
        <div class=" bg-white-100	 shadow-md rounded-lg px-8 py-6 max-w-md">
            <h1 class="text-2xl font-bold text-center mb-4 dark">Welcome Back!</h1>
            <form action="#">
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-700 dark mb-2">Email Address</label>
                ...
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-gray-700 dark mb-2">Password</label>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-gray-700 dark">Remember me</label>
                    </div>
                    <a href="#"
